                                            ...
                                            <div class="col-md-6 col-xl-4">
                                                <div class="product-wrapper mb-30">
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <br>Stok: {{$product->productInventory->qty}}
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- end -->
                                            ...
                                            <div class="product-wrapper mb-30 single-product-list product-list-right-pr mb-60">
                                                ...
                                                <div class="product-content-list">
                                                    <div class="product-list-info">
                                                        ...
                                                        <br>Stok Barang: {{ $product->productInventory->qty}}`
                                                    </div>
                                                    <div class="product-list-cart-wishlist">
                                                        <div class="product-list-cart">
                                                            <a class="btn-hover list-btn-style add-to-card" href=""  product-id="{{ $product->id }}" product-type="{{ $product->type }}" product-slug="{{ $product->slug }}">Masukkan Ke Keranjang</a>
                                                        </div>
